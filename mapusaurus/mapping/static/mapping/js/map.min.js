...
function init() {
    console.log("init fired"), console.log(msgToggle), msgToggle.show();
...
window.console || (console = {
    ...
    togglePeers(peerStatus)) : addParam("peers", !1), $("#peerSelect").change(function() {
        ...
        $("#branchSelect").prop("checked") && toggleBranches(!0), console.log("MOVEEND");
    }), map.on("moveend", init), map.on("movestart", function() {
        lastXHR && 4 !== lastXHR.readyState && (lastXHR.abort(), hideLoadingUI());
...
}(), rawGeo, rawLar, rawMinority, rawData, lastXHR, dataStore = {};
