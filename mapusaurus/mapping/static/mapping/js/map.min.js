...
function initVoronoi() {
    ...
    return function(collection) {
        ...
        svg.selectAll(".voronoi").remove(), polygons.forEach(function(v) {
            v.cell = v;
        }), svg.selectAll("path").data(polygons).enter().append("svg:path").attr("class", "voronoi").attr({
            d: function(d) {
                return d ? "M" + d.cell.join("L") + "Z" : null;
            },
            stroke: "black",
            fill: "none"
